  ...
  return (
    <section className="flex min-h-dvh items-center justify-center p-4"
      ...
      <div className="w-full max-w-md rounded-xl p-8"
        ...
        <h1 className="mb-6 text-xl font-bold text-white">Registrarse</h1>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="email" className="text-[13px]" style={{ color: 'var(--fourth)' }}>Email</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="password" className="text-[13px]" style={{ color: 'var(--fourth)' }}>Contraseña</label>
        ...
        <p className="mt-5 text-center text-[13px]" style={{ color: 'var(--fourth)' }}>
          ¿Ya tienes cuenta?{' '}
          <Link to="/login" className="font-medium underline transition-opacity hover:opacity-80"
            style={{ color: 'var(--third)' }}>
            Iniciar sesión
          </Link>
        </p>
